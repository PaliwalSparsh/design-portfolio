...
function ProjectCard(props) {
  ...
  const isComponentLibrary = props.title==="Component Library"
  const isOtherProject = !isVRProject && !isComponentLibrary
  return (
    <div className="w-full sm:w-[48%] xl:w-80 mt-12 sm:mh-8 xl:mr-16 inline-block">
      ...
      <a href={props.link}>
        <div className="mt-4 xl:w-80 h-80 flex bg-neutral-900 rounded-2xl hover:shadow-lg hover:rotate-[3deg]">
          <div className={clsx("m-auto image-wrapper", {"w-[65%] sm:w-1/2 xl:w-full": isVRProject, "w-[40%] md:w-1/3 xl:w-1/2": isComponentLibrary, "w-4/5 md:w-3/5 xl:w-4/5": isOtherProject})} >
